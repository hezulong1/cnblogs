...
function deliverC2Mobile() {
  $("#div-gpt-ad-1539008685004-0").hide();
  $("#cnblogs_c2").css("width", "320px").css("height", "auto");
  var n = document.createElement("script");
  n.src = "https://js.shshuoshu.com/dsp/code/940.js";
  document.getElementById("cnblogs_c2").appendChild(n)
}

function deliverC2Adsense() {
  $("#cnblogs_c2").css("width", "320px").css("height", "50px").html('        <script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"><\/script>        <ins class="adsbygoogle"             style="display:inline-block;width:320px;height:50px"             data-ad-client="ca-pub-4210569241504288"             data-ad-slot="4563868684"><\/ins>        <script>        (adsbygoogle = window.adsbygoogle || []).push({});        <\/script>')
}
...
function passSiteHome() {
  $("#sitehome_pass").html("<span style='color:red'>操作中...<\/span>");
  $.ajax({
    url: "https://audit.cnblogs.com/blogPosts-home/pass/" + cb_entryId,
    type: "post",
    xhrFields: {
      withCredentials: !0
    },
    success: function () {
      $("#sitehome_pass").html("<span style='color:red'>审核通过<\/span>")
    },
    error: function () {
      $("#sitehome_pass").html("<span style='color:red'>操作失败！<\/span>")
    }
  })
}

function outFromAggHome() {
  $("#site_editor_opt").html("<span style='color:red'>操作中...<\/span>");
  $.ajax({
    ...
    contentType: "application/json; charset=utf-8",
    success: function (n) {
      n.success ? $("#site_editor_opt").html("<span style='color:red'>操作成功<\/span>") : $("#site_editor_opt").html("<span style='color:red'>操作失败!" + n.message + "<\/span>")
    },
    error: function () {
      $("#site_editor_opt").html("<span style='color:red'>操作失败<\/span>")
    }
  })
}
...
function BigBannerDelivery(n) {
  ...
  this.canShowBanner = function () {
    var n = new Date,
      t = n > new Date(2020, 3, 19, 0, 0) && n < new Date(2020, 6, 1, 0, 0);
...
var JSON, accountBaseAddress, account, getMarkdownEditor, initCommentEditor, currentDelElement, currentCommentID, insertUBB, initBlogSubscribeManager, buildVoteNode;
JSON || (JSON = {}),
  function () {
    "use strict";
